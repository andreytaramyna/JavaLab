...
public class GraphicsDisplay extends JPanel {
    ...
    public GraphicsDisplay() {
        ...
        this.addMouseListener(new MouseHandler());//вот это ответ на последний вопрос
    ...
    public class MouseHandler extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent ev) {//удерживние без перемещения
            if (ev.getButton() == 1) {
        ...
        public void mouseReleased(MouseEvent ev) {//отпустить просто
            if (ev.getButton() == 1) {
    ...
    public class MouseMotionHandler implements MouseMotionListener {
        ...
        public void mouseDragged(MouseEvent ev) {//перемещение с нажатием
            if (GraphicsDisplay.this.changeMode) {
